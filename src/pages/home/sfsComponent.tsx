...
const SfsComponent = () => {
  return (
    <div className="p-6 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="hidden md:flex flex-col items-center justify-center text-white text-6xl font-bold text-[100px] md:mr-6">
...
<div className="flex flex-col md:flex-row items-center justify-between flex-1 text-white md:ml-6 mt-6 md:mt-0 bg-[#0F4C5C] px-4  pt-4 md:pl-6 md:pr-0 md:py-0 w-full border border-white md:border-none rounded-none md:rounded-[52px]">


        {/* Paragraph and Button */}
        <div className="md:w-1/2 pr-4">
          <p className="text-lg mb-4">
            Welcome to Binayah Properties Dubai, the Award-Winning Real Estate
        ...
        {/* Image */}
        <div className="md:w-3/4 mt-6 md:mt-0 flex justify-end items-end">
          <img
            src={Image}
            alt="Property"
